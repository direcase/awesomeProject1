...
type PrimeServiceClient interface {
	Do(ctx context.Context, opts ...grpc.CallOption) (PrimeService_DoClient, error)
}
...
func (c *primeServiceClient) Do(ctx context.Context, opts ...grpc.CallOption) (PrimeService_DoClient, error) {
...
func (x *primeServiceDoClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *primeServiceDoClient) CloseAndRecv() (*Response, error) {
...
type PrimeServiceServer interface {
	Do(PrimeService_DoServer) error
...
func (UnimplementedPrimeServiceServer) Do(PrimeService_DoServer) error {
...
func _PrimeService_Do_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PrimeServiceServer).Do(&primeServiceDoServer{stream})
}
...
func (x *primeServiceDoServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *primeServiceDoServer) Recv() (*Request, error) {
	m := new(Request)
